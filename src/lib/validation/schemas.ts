...
export const columnMappingSchema = z.object({
  ...
  lipid_medication: z.string().optional().transform(val => val === '__none__' ? undefined : val),
  family_history_ihd: z.string().optional().transform(val => val === '__none__' ? undefined : val),
  ethnicity: z.string().optional().transform(val => val === '__none__' ? undefined : val),
  subject_id: z.string().optional().transform(val => val === '__none__' ? undefined : val),
});